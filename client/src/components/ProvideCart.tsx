...
export default function ProvideCart() {
  return (
    <div className="xlmargin">
        ...
        <p className="navbar text-[#999999] w-[60%]">With StreamVibe, you can enjoy your favorite movies and TV shows anytime, anywhere. Our platform is designed to be compatible with a wide range of devices, ensuring that you never miss a moment of entertainment.</p>

        
        <div className="header flex items-center gap-10">
            {
              proveCarts.map(item => (
                <div className="w-[500px] prove-cart bg-[#0F0F0F] roudned bg-gradient-to-tr from-black to-[#e50000]/10 ">
